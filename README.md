...
**Safe Climate Keeper**  
Monitors room temperature and humidity via a DHT sensor (displayed on LCD). An MQ2 gas sensor and IR flame sensor watch for hazards — a buzzer triggers when any smoke or flame are detected.
